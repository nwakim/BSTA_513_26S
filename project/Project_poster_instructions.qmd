...
-   **Some important methods to discuss** (You may divide these into your sections, not necessarily with these names)
    ...
    -   Variables and variable creation
        -   [For purposeful model selection]{style="color:#70AD47"} AND LASSO: This includes a description of analyses for Table 1 and what statistics were used to summarize the variables
