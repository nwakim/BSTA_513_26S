...
\begin{tcolorbox}[enhanced jigsaw, colback=white, bottomrule=.15mm, colframe=quarto-callout-important-color-frame, toptitle=1mm, leftrule=.75mm, arc=.35mm, colbacktitle=quarto-callout-important-color!10!white, coltitle=black, left=2mm, bottomtitle=1mm, titlerule=0mm, breakable, opacitybacktitle=0.6, rightrule=.15mm, toprule=.15mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Project template}, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, toptitle=1mm, leftrule=.75mm, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, left=2mm, bottomtitle=1mm, titlerule=0mm, breakable, opacitybacktitle=0.6, rightrule=.15mm, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{The project report is a separate file from the labs}, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, bottomrule=.15mm, colframe=quarto-callout-important-color-frame, toptitle=1mm, leftrule=.75mm, arc=.35mm, colbacktitle=quarto-callout-important-color!10!white, coltitle=black, left=2mm, bottomtitle=1mm, titlerule=0mm, breakable, opacitybacktitle=0.6, rightrule=.15mm, toprule=.15mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Some words on my grading process}, opacityback=0]
...
\item
  ...
  \end{itemize}
\item
  Another important table may include model assessment values like AUC
...
\tightlist
\item
  When deciding to create a table or figure, ask yourself: Does this
  help the reader understand what I am saying in text? Can it be
  conveyed just as well with words?
