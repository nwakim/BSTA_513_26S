...
-   [NIH's page: Food Insecurity, Neighborhood Food Environment, and Nutrition Health Disparities: State of the Science](https://www.nhlbi.nih.gov/events/2021/food-insecurity-neighborhood-food-environment-and-nutrition-health-disparities)
...
1.  Go to the [Health and Medical Care Archive page for the 2023 Well-Being and Basic Needs Survey](https://www.icpsr.umich.edu/web/ICPSR/studies/39462/datadocumentation)
...
#### For purposeful model selection and LASSO regression
...
There is a [good online version of the codebook](https://www.icpsr.umich.edu/web/HMCA/studies/39462/datasets/0002/variables/ID?archive=HMCA) with information about the variables. I have linked you to the ID varaible, but you can take a look at all the other variables using the left hand side navigator:
...
From the above readings, survey information, and your list of predictors in @sec-pred, which predictors do you think will be the most important to predict food insecurity?
...
We will once again do a complete case analysis (aka drop observations with any missing data). You can use the `drop_na()` function from the `tidyr` package to do this.
...
[Check out the Table 1 I made](https://nwakim.github.io/BSTA_512_26W/lessons/16_Poster_help/16_Poster_help.html#/table-1-table-summary-in-lesson-2) for the gapminder data in BSTA 512/612. 
