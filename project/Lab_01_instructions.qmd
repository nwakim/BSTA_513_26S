...
- **For LASSO:** because we're leaving in a lot of variables, we need to remove the ones that have a majority missing values. I dropped NA's with the following:
```{r}
#| eval: false
