...
::: blue
With continuity correction: 0.6 (95% CI: 0.452, 0.733)
Without continuity correction: 0.6 (95% CI: 0.464, 0.736)
:::
...
|------------|------------|------------|------------|------------|------------|
| Single proportion | 1 | Nominal, binary | None | $H_0: \widehat{p}=p, H_1: \widehat{p} \neq p$ | `prop.test()` |
| Chi-squared test for general association |  |  |  |  |  |
| Fisher's Exact test for general association |  |  |  |  |  |
| Cochran-Armitage test for trend |  |  |  |  |  |
| Mantel-Haenszel test for linear trend |  |  |  |  |  |
