...
|---------------|---------------|---------------|---------------|---------------|
| Sheetal Akula | [akula\@ohsu.edu](mailto:akula@ohsu.edu){.email} | TBD | TBD | TBD |
| Kelsey Mackenzie | [mackenzie\@ohsu.edu](mailto:mackenzie@ohsu.edu){.email} | TBD | TBD | TBD |
| Sophia Mann | [mannso\@ohsu.edu](mailto:mannso@ohsu.edu){.email} | TBD | TBD | TBD |
